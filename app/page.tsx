      ...
      <section className="relative overflow-hidden pt-24 pb-40 px-4">
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.9] mb-12">
            THINK IN ENGLISH,<br />
            <span className="block mt-4 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 bg-clip-text text-transparent px-4 tracking-tight">NOT TRANSLATION.</span>
          </h1>
